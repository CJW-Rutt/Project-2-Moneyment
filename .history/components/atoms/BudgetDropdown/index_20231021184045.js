...
export default function SelectWithGroupsShowcase() {

    const [selectedIndex, setSelectedIndex] = useState < IndexPath | IndexPath[] > (new IndexPath(0, 1));
    const [multiSelectedIndex, setMultiSelectedIndex] = useState < IndexPath | IndexPath[] > ([
        new IndexPath(0, 0),
        new IndexPath(1, 1),
    ]);
